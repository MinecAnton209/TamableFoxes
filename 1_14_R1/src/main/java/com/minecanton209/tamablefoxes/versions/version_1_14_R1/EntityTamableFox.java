package com.minecanton209.tamablefoxes.versions.version_1_14_R1;
...
import com.minecanton209.tamablefoxes.versions.version_1_14_R1.pathfinding.*;
...
public class EntityTamableFox extends EntityFox implements ITamableFoxAdapter {
    ...
    public void initPathfinder() {
        try {
            ...
            turtleEggTargetGoal.set(this, new PathfinderGoalNearestAttackableTarget(this, EntityTurtle.class, 10, false, false, (entityLiving) -> {
                return (!isTamed() || (com.minecanton209.tamablefoxes.util.io.Config.doesTamedAttackWildAnimals() && isTamed())) && EntityTurtle.bz.test((EntityLiving) entityLiving);
            }));
    ...
    // Note: getHealth(), getMaxHealth(), getBukkitEntity(), getItemInMainHand(), hasItemInMainHand()
    // are satisfied by the parent NMS class methods already.
