package com.minecanton209.tamablefoxes.versions.version_1_16_R1;
...
import com.minecanton209.tamablefoxes.versions.version_1_16_R1.pathfinding.*;
...
public class EntityTamableFox extends EntityFox implements ITamableFoxAdapter {
    ...
    private static final DataWatcherObject<Byte> bw;
    private static final Predicate<Entity> bC;
    ...
    public void initPathfinder() {
        try {
            ...
            Field landTargetGoal = this.getClass().getSuperclass().getDeclaredField("bD");
            ...
            Field turtleEggTargetGoal = this.getClass().getSuperclass().getDeclaredField("bE");
            ...
            turtleEggTargetGoal.set(this, new PathfinderGoalNearestAttackableTarget(this, EntityTurtle.class, 10, false, false, (entityLiving) -> {
                return (!isTamed() || (com.minecanton209.tamablefoxes.util.io.Config.doesTamedAttackWildAnimals() && isTamed())) && EntityTurtle.bv.test((EntityLiving) entityLiving);
            }));

            Field fishTargetGoal = this.getClass().getSuperclass().getDeclaredField("bF");
            ...
            this.goalSelector.a(12, getFoxInnerPathfinderGoal("j", Arrays.asList(this, EntityHuman.class, 24.0f),
                        Arrays.asList(EntityInsentient.class, Class.class, float.class)));
