package com.minecanton209.tamablefoxes.versions.version_1_16_R2;
...
import com.minecanton209.tamablefoxes.versions.version_1_16_R2.pathfinding.*;
...
public class EntityTamableFox extends EntityFox implements ITamableFoxAdapter {
    ...
    public void initPathfinder() {
        try {
            ...
            Field landTargetGoal = this.getClass().getSuperclass().getDeclaredField("bw");
            ...
            Field turtleEggTargetGoal = this.getClass().getSuperclass().getDeclaredField("bx");
            ...
            Field fishTargetGoal = this.getClass().getSuperclass().getDeclaredField("by");
